...
![numpy api coverage](https://img.shields.io/badge/numpy_api_coverage-76%20%25-yellow)
...
- **📊 Extensive API** — **252 of 333 NumPy functions (75.7% coverage)**
...
**Overall: 252/333 functions (75.7% complete)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 252/333 (76%) | ~20% | Different | ML-focused |
