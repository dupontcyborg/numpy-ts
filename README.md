...
- **📊 Extensive API** — **294 of 507 NumPy functions (58.0% coverage)**
...
**Overall: 294/507 functions (58.0% complete)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 294/507 (58%) | ~20% | Different | ML-focused |
