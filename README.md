...
![full bundle gzipped size](https://img.shields.io/badge/size%20(full)-600%20kB-blue)
![core import gzipped size](https://img.shields.io/badge/size%20(single)-15%20kB-blue)
...
- **🏃🏽‍♂️ Fast** — [1.25x faster than NumPy](https://numpyts.dev/performance) on average across 7,200 benchmarks, thanks to Zig-WASM SIMD kernels
