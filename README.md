...
![numpy api coverage](https://img.shields.io/badge/numpy_api_coverage-91%20%25-brightgreen)
...
- **📊 Extensive API** — **302 of 333 NumPy functions (90.7% coverage)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 302/333 (91%) | ~20% | Different | ML-focused |
