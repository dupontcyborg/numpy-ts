...
![numpy api coverage](https://img.shields.io/badge/numpy_api_coverage-89%20%25-yellow)
...
- **📊 Extensive API** — **296 of 333 NumPy functions (88.9% coverage)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 296/333 (89%) | ~20% | Different | ML-focused |
