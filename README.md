...
![full bundle gzipped size](https://img.shields.io/badge/size%20(full)-631%20kB-blue)
![core import gzipped size](https://img.shields.io/badge/size%20(single)-17%20kB-blue)
...
![validated against NumPy 2.4](https://img.shields.io/badge/validated_against-NumPy_2.4-013243?logo=numpy&logoColor=white)
...
- **🏃🏽‍♂️ Fast** — [1.36x faster than NumPy](https://numpyts.dev/performance) on average across 10,500 benchmarks, thanks to Zig-WASM SIMD kernels
