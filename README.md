...
![numpy api coverage](https://img.shields.io/badge/numpy_api_coverage-75%20%25-yellow)
...
- **📊 Extensive API** — **378 of 507 NumPy functions (74.6% coverage)**
...
**Overall: 378/507 functions (74.6% complete)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 378/507 (75%) | ~20% | Different | ML-focused |
