/**
 * WASM-accelerated element-wise inverse hyperbolic sine.
 *
...
import * as arcsinhBase from './bins/arcsinh.wasm';
import * as arcsinhRelaxed from './bins/arcsinh-relaxed.wasm';
...
let _bins: typeof arcsinhBase | null = null;
function bins(): typeof arcsinhBase {
  _bins ??= useRelaxedKernels() ? arcsinhRelaxed : arcsinhBase;
  return _bins;
}

const kernels: Partial<Record<DType, UnaryFn>> = {
  float64: (...a) => bins().arcsinh_f64(...a),
  float32: (...a) => bins().arcsinh_f32(...a),
};

// Large int → f64 output (i32/u32/i64/u64 need f64 precision)
const largeIntKernels: Partial<Record<DType, UnaryFn>> = {
  int64: (...a) => bins().arcsinh_i64_f64(...a),
  uint64: (...a) => bins().arcsinh_u64_f64(...a),
  int32: (...a) => bins().arcsinh_i32_f64(...a),
  uint32: (...a) => bins().arcsinh_u32_f64(...a),
};

// Small int → f32 output (i8/u8/i16/u16 → f32, then optionally downcast to f16)
const smallIntKernels: Partial<Record<DType, UnaryFn>> = {
  int16: (...a) => bins().arcsinh_i16_f32(...a),
  uint16: (...a) => bins().arcsinh_u16_f32(...a),
  int8: (...a) => bins().arcsinh_i8_f32(...a),
  uint8: (...a) => bins().arcsinh_u8_f32(...a),
};
 ...
 */
export function wasmArcsinh(a: ArrayStorage): ArrayStorage | null {
  ...
  if (dtype === 'float16') {
    ...
    bins().arcsinh_f32(aPtr, outRegion.ptr, size);
