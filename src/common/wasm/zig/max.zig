...
/// Element-wise maximum for i64, scalar (LLVM scalarizes i64x2 @select).
...
/// Element-wise maximum with scalar for i64, scalar.
...
/// Element-wise maximum for u64, scalar (LLVM scalarizes i64x2 @select).
...
/// Element-wise maximum with scalar for u64, scalar.
