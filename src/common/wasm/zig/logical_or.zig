...
/// Element-wise logical OR for i64 — 2-wide.
...
/// Element-wise logical OR against a scalar for i64 — 2-wide.
/// A non-zero scalar makes the whole result true, so it short-circuits to a fill.
