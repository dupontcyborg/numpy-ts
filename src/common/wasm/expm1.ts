/**
 * WASM-accelerated element-wise expm1 (e^x − 1).
 *
...
import * as expm1Base from './bins/expm1.wasm';
import * as expm1Relaxed from './bins/expm1-relaxed.wasm';
...
let _bins: typeof expm1Base | null = null;
function bins(): typeof expm1Base {
  _bins ??= useRelaxedKernels() ? expm1Relaxed : expm1Base;
  return _bins;
}

const kernels: Partial<Record<DType, UnaryFn>> = {
  float64: (...a) => bins().expm1_f64(...a),
  float32: (...a) => bins().expm1_f32(...a),
};

// Large int → f64 output (i32/u32/i64/u64 need f64 precision)
const largeIntKernels: Partial<Record<DType, UnaryFn>> = {
  int64: (...a) => bins().expm1_i64_f64(...a),
  uint64: (...a) => bins().expm1_u64_f64(...a),
  int32: (...a) => bins().expm1_i32_f64(...a),
  uint32: (...a) => bins().expm1_u32_f64(...a),
};

// Small int → f32 output (i8/u8/i16/u16 → f32, then optionally downcast to f16)
const smallIntKernels: Partial<Record<DType, UnaryFn>> = {
  int16: (...a) => bins().expm1_i16_f32(...a),
  uint16: (...a) => bins().expm1_u16_f32(...a),
  int8: (...a) => bins().expm1_i8_f32(...a),
  uint8: (...a) => bins().expm1_u8_f32(...a),
};
 ...
 */
export function wasmExpm1(a: ArrayStorage): ArrayStorage | null {
  ...
  if (dtype === 'float16') {
    ...
    bins().expm1_f32(aPtr, outRegion.ptr, size);
