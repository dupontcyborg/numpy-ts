...
describe('vindex', () => {
  ...
  describe('mixing advanced and slice indices', () => {
    ...
    it('discontiguous array indices are moved to front', () => {
      ...
      expect(result.shape).toEqual([1, 7, 2]);
    });
  });
