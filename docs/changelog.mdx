...
numpy-ts is now roughly **1.3x faster than NumPy** over the suite (see [benchmarks](/performance) for more details). Coverage grew from 2,390 to 3,513 cases, sweeping every operation across all applicable dtypes.
