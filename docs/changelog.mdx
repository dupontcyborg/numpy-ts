...
**This is the first release where numpy-ts is faster than native NumPy on average** — **1.11x** across 7,200 benchmarks, leading in 12 of 18 categories. See the [Performance Overview](./v1.3.x/performance/overview) for the full breakdown.
