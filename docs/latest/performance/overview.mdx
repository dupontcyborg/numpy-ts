...
<img
  ...
  src="/assets/v1.7.x/overview-categories-light.png"
  alt="Performance by category: numpy-ts vs NumPy"
/>
<img
  className="hidden dark:block"
  src="/assets/v1.7.x/overview-categories-dark.png"
  alt="Performance by category: numpy-ts vs NumPy"
/>
</Frame>
...
Smaller data types see the biggest gains — numpy-ts's SIMD kernels process more elements per instruction, and `float16` leads at 1.59x. Even `float64` (NumPy's home turf) is 1.35x faster. Complex types are the exception, where NumPy still leads.

<Frame>
<img
  className="block dark:hidden"
  src="/assets/v1.7.x/overview-dtypes-light.png"
  alt="Performance by data type: numpy-ts vs NumPy"
/>
<img
  className="hidden dark:block"
  src="/assets/v1.7.x/overview-dtypes-dark.png"
  alt="Performance by data type: numpy-ts vs NumPy"
/>
</Frame>
...
<img
  className="block dark:hidden"
  src="/assets/v1.7.x/overview-scaling-light.png"
  alt="Performance by array size: numpy-ts vs NumPy"
/>
<img
  className="hidden dark:block"
  src="/assets/v1.7.x/overview-scaling-dark.png"
  alt="Performance by array size: numpy-ts vs NumPy"
/>
</Frame>
