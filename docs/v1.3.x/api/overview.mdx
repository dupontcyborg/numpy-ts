...
canonical: https://numpyts.dev/latest/api/overview
---
...
<Tip>
On top of full coverage, numpy-ts is **1.13x faster than NumPy on average** across 7,159 benchmarks. See the full [performance breakdown](/performance).
</Tip>
