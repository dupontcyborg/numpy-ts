...
// Inheritance
full instanceof NDArrayCore;  // true (NDArray extends NDArrayCore)
```
...
| `numpy-ts/io` | Browser-compatible I/O (parseNpy, serializeNpy) |
...
```typescript
import { parseNpy, serializeNpy, parseNpz, serializeNpz } from 'numpy-ts/io';
