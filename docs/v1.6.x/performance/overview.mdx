...
<img
  ...
  src="/assets/v1.5.x/overview-categories-light.png"
  alt="Performance by category: numpy-ts vs NumPy"
/>
<img
  className="hidden dark:block"
  src="/assets/v1.5.x/overview-categories-dark.png"
  alt="Performance by category: numpy-ts vs NumPy"
/>
</Frame>
...
<img
  className="block dark:hidden"
  src="/assets/v1.5.x/overview-dtypes-light.png"
  alt="Performance by data type: numpy-ts vs NumPy"
/>
<img
  className="hidden dark:block"
  src="/assets/v1.5.x/overview-dtypes-dark.png"
  alt="Performance by data type: numpy-ts vs NumPy"
/>
</Frame>
...
<img
  className="block dark:hidden"
  src="/assets/v1.5.x/overview-scaling-light.png"
  alt="Performance by array size: numpy-ts vs NumPy"
/>
<img
  className="hidden dark:block"
  src="/assets/v1.5.x/overview-scaling-dark.png"
  alt="Performance by array size: numpy-ts vs NumPy"
/>
</Frame>
