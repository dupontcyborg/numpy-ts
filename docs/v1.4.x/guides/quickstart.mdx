...
canonical: https://numpyts.dev/latest/guides/quickstart
---

## Install

numpy-ts has zero runtime dependencies and works on all major JavaScript runtimes.
...
```bash deno
deno add npm:numpy-ts
```
</CodeGroup>

<Tip>
Browser? Skip the install and load directly from a CDN — see [Installation](.//installation#cdn-usage-browsers).
</Tip>
