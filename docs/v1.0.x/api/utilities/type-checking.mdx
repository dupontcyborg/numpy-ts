...
```typescript
function min_scalar_type(a: number): DType
```

| Parameter | Type | Default | Description |
|---|---|---|---|
| `a` | `number` | -- | A scalar value. |
...
```typescript
function issubdtype(arg1: DType, arg2: DType | string): boolean
```

| Parameter | Type | Default | Description |
|---|---|---|---|
| `arg1` | `DType` | -- | The dtype to test. |
| `arg2` | `DType \| string` | -- | The dtype or abstract type category to test against (e.g. `'integer'`, `'floating'`, `'signedinteger'`, `'unsignedinteger'`, `'number'`). |
...
```typescript
function typename(num: number): string
```

| Parameter | Type | Default | Description |
|---|---|---|---|
| `num` | `number` | -- | A numeric type code. |
...
| Parameter | Type | Default | Description |
|---|---|---|---|
| `typechars` | `string[]` | -- | Array of type character codes. |
