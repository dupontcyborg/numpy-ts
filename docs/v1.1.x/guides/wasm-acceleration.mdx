...
canonical: https://numpyts.dev/latest/guides/wasm-acceleration
---
...
<Note>
All benchmarks measure computation time *within* numpy-ts and *within* NumPy respectively -- no FFI or serialization overhead is counted. This gives an apples-to-apples comparison of the numerical computation itself. For more info, see [performance benchmarks](./performance).
</Note>
