...
**Claude was used primarily during the prototype and early implementation phase** (Nov 2025 - Jan 2026) to accelerate the initial buildout of numpy-ts's 200+ API functions. This included generating first-pass implementations of well-specified NumPy functions, test scaffolding, and documentation.
