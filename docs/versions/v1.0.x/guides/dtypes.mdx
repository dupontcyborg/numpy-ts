...
<CardGroup cols={2}>
  <Card title="Array Basics" icon="cube" href="/versions/v1.0.x/guides/array-basics">
    NDArray properties, creation, and conversion.
  </Card>
  <Card title="Broadcasting" icon="arrows-up-down-left-right" href="/versions/v1.0.x/guides/broadcasting">
