...
<Note>
If bundle size matters more than method chaining, use `numpy-ts/core` instead. See the [Installation guide](/versions/v1.0.x/getting-started/installation) for details.
</Note>
