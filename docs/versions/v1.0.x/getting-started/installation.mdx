...
<Tip>
Importing just `array` and `add` from `numpy-ts/core` results in a bundle around **10 KB** minified. The full entry point is always ~200-300 KB regardless of what you use. See the [Tree-Shaking guide](/versions/v1.0.x/guides/tree-shaking) for a detailed comparison.
</Tip>
...
<CardGroup cols={3}>
  ...
  <Card title="NumPy Migration Guide" icon="code-compare" href="/versions/v1.0.x/getting-started/numpy-migration">
