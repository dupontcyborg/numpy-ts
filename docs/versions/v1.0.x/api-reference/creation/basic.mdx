...
```typescript
function require(a: ArrayLike, dtype?: DType, requirements?: string[]): NDArray
```
...
| `requirements` | `string[]` | `undefined` | Memory layout requirements (e.g., `['C']`). Mostly no-ops in numpy-ts. |
