...
```typescript
function equal(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function not_equal(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function greater(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function greater_equal(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function less(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function less_equal(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function allclose(a: ArrayLike, b: ArrayLike, rtol?: number, atol?: number): boolean
```
...
```typescript
function isclose(a: ArrayLike, b: ArrayLike, rtol?: number, atol?: number, equal_nan?: boolean): NDArray
```
...
```typescript
function array_equal(a1: ArrayLike, a2: ArrayLike): boolean
```

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `a1` | `ArrayLike` | -- | First input array. |
| `a2` | `ArrayLike` | -- | Second input array. |
...
```typescript
function array_equiv(a1: ArrayLike, a2: ArrayLike): boolean
```
