...
```typescript
function bitwise_and(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function bitwise_or(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function bitwise_xor(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function left_shift(x1: ArrayLike, x2: ArrayLike): NDArray
```
...
```typescript
function right_shift(x1: ArrayLike, x2: ArrayLike): NDArray
```
