...
```typescript
function parseNpyHeader(buffer: ArrayBuffer | Uint8Array): NpyHeader
```
...
```typescript
function parseNpyData(bytes: Uint8Array, metadata: NpyMetadata): NDArray
```
...
```typescript
function serializeNpy(array: NDArray): Uint8Array
```

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `array` | `NDArray` | -- | The array to serialize. |
...
```typescript
function load(filepath: string): Promise<NDArray | Record<string, NDArray>>
```

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `filepath` | `string` | -- | Path to a `.npy` or `.npz` file. |
...
```typescript
function save(filepath: string, array: NDArray): Promise<void>
```

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `filepath` | `string` | -- | Output path (should end with `.npy`). |
...
```typescript
function savez(filepath: string, arrays: Record<string, NDArray>): Promise<void>
```

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `filepath` | `string` | -- | Output path. `.npz` extension is appended if missing. |
...
```typescript
function savez_compressed(filepath: string, arrays: Record<string, NDArray>): Promise<void>
```
